 ...
 * Proxy to backend POST /api/admin/placements/[id]/record-payment
 */
export async function POST(
  ...
  try {
    ...
    const url = `${BACKEND_URL}/api/admin/placements/${id}/record-payment`;
    ...
    console.error('Admin record payment proxy error:', error);
    return NextResponse.json(
