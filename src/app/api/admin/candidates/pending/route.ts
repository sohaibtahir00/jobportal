 ...
 * Proxy to backend GET /api/admin/candidates/pending
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const url = `${BACKEND_URL}/api/admin/candidates/pending${queryString ? `?${queryString}` : ''}`;
    ...
    console.error('Admin candidates proxy error:', error);
    return NextResponse.json(
