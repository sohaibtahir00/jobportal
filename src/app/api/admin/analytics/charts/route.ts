 ...
 * Proxy to backend GET /api/admin/analytics/charts
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const url = `${BACKEND_URL}/api/admin/analytics/charts${queryString ? `?${queryString}` : ''}`;
    ...
    console.error('Admin analytics charts proxy error:', error);
    return NextResponse.json(
