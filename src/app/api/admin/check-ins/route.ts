 ...
 * Proxy to backend GET /api/admin/check-ins
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const url = `${BACKEND_URL}/api/admin/check-ins${queryString ? `?${queryString}` : ''}`;
    ...
    console.error('Admin check-ins proxy error:', error);
    return NextResponse.json(
