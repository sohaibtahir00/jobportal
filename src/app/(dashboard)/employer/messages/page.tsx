...
export default function EmployerMessagesPage() {
  ...
  useEffect(() => {
    if (status === "unauthenticated") {
      router.push("/login?redirect=/employer/messages");
    }
  ...
  const loadThread = async (participantId: string) => {
    try {
      ...
      if (!conversation) {
        // No existing conversation, initialize empty thread
        setCurrentThread({
          messages: [],
          totalCount: 0,
          participants: [],
      ...
      // If 404, it means no conversation exists yet, which is fine
      ...
      <div className="container">
        <div className="mx-auto max-w-7xl">
          <div className="mb-6">
            ...
            <p className="text-secondary-600">Communicate with candidates</p>
          </div>
                  ...
                  {filteredConversations.length === 0 ? (
                    <div className="p-8 text-center">
                      ...
                      <p className="mt-2 text-xs text-secondary-500">
                        Start conversations with candidates from their profile or applicant page
                      </p>
                    </div>
                  ) : (
                          ...
                          <div className="flex-1 flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="mb-1 flex items-center gap-2">
                                ...
                                <Badge
                                  variant={
                                    conv.participant.role === "CANDIDATE" ? "primary" : "secondary"
                                  }
                                  size="sm"
                                  className="text-xs flex-shrink-0"
                                >
                                  {conv.participant.role === "CANDIDATE"
                                    ? "Candidate"
